...
<body>
    ...
    <script src="<?= base_url('assets_guru/') ?>js/main.js"></script>


    <script src="<?= base_url('assets_guru/') ?>vendors/chart.js/dist/Chart.bundle.min.js"></script>
    <script src="<?= base_url('assets_guru/') ?>js/dashboard.js"></script>
    <script src="<?= base_url('assets_guru/') ?>js/widgets.js"></script>
