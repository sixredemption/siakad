    ...
    <div id="home" class="slider-area">
        <div class="bend niceties preview-2">
            <div id="ensign-nivoslider" class="slides">
                <img src="<?= base_url('assets_home/') ?>img/slider/slider1.jpg" alt="" title="#slider-direction-1" />
                <img src="<?= base_url('assets_home/') ?>img/slider/slider2.jpg" alt="" title="#slider-direction-2" />
                <img src="<?= base_url('assets_home/') ?>img/slider/slider3.jpg" alt="" title="#slider-direction-3" />
            </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="well-left">
                        <div class="single-well">
                            <a href="#">
                                <img src="<?= base_url('assets_home/') ?>img/about/1.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="check1" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <p>
                                            Redug Lefes dolor sit amet, consectetur adipisicing elit. Aspernatur, tempore, commodi quas
                                            mollitia dolore magnam quidem repellat, culpa voluptates laboriosam maiores alias accusamus
                                            recusandae vero
                                        </p>
                                    </div>
                                </div>
